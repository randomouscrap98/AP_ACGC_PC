...
# Only used for the generated .clangd: where the SDL2 headers live on your *host* (not the
# container). The default is for Arch; override it (e.g. HOST_SDL2_INCLUDE=/usr/include/SDL2
# ./build_podman.sh) or edit it here.
HOST_SDL2_INCLUDE="${HOST_SDL2_INCLUDE:-/usr/include/SDL2}"
...
if [ -n "$HOST_DIR" ]; then
  ...
  {
    echo "# Generated by build_mingw.sh, do not edit (change HOST_SDL2_INCLUDE there instead)"
    echo "CompileFlags:"
    echo "  CompilationDatabase: pc/build32"
    echo "  Add:"
    echo "    - -I$HOST_SDL2_INCLUDE"
    while read -r dir; do
